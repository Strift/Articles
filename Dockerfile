...
RUN apt-get update && apt-get -y install git curl php7.2-mcrypt php7.2-json php7.2-sqlite php7.2-mbstring php7.2-xml php7.2-zip && apt-get -y autoremove && apt-get clean && rm -rf /var/lib/apt/lists/*
